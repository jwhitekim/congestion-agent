...
extract_tool_calls/extract_text/append_tool_results/extract_usage 6개 메서드만
구현하면 agent/loop.py의 tool_use 루프가 그대로 돌린다(duck typing).

새 프로바이더를 추가하려면 이 패키지에 파일을 추가해 위 6개 메서드를 구현한
